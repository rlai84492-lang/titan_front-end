...
//       'BIRTHDAY_T10_CATALOGUE_FOLLOW_UP_SENT',  // ← ADD KARO
...
export const FLOW_STEPS = {
  bday_t10: [
    ...
    'BIRTHDAY_T10_GENDER_SELECTION_SENT',      //     59
    'BIRTHDAY_T10_MEN_BRAND_CAROUSEL_SENT',    //     98
    'BIRTHDAY_T10_WOMEN_BRAND_CAROUSEL_SENT',  //     58
    'BIRTHDAY_T10_CATALOGUE_SENT',             //      1
    'BIRTHDAY_T10_CATALOGUE_FOLLOW_UP_SENT',   //     85 ✅ ADDED
    'BIRTHDAY_T10_OFFER_SENT',                 //    684
    'BIRTHDAY_T10_STORE_VISIT_SENT',           //     59
    'BIRTHDAY_T10_CALLBACK_CONFIRMED',         //     17
  ],
  bday_t0: [
    // 'BIRTHDAY_TDAY_TEMPLATE_SENT',                    // 253,440
    'BIRTHDAY_TDAY_OPENER_SENT',                      //   5,655
    'BIRTHDAY_TDAY_GENDER_SELECTION_SENT',            //     138
    'BIRTHDAY_TDAY_MEN_BRAND_CAROUSEL_SENT',          //     129
    'BIRTHDAY_TDAY_WOMEN_BRAND_CAROUSEL_SENT',        //      67
    'BIRTHDAY_TDAY_CATALOGUE_FOLLOW_UP_SENT',         //     129
    'BIRTHDAY_TDAY_OFFER_SENT',                       //   1,030
    'BIRTHDAY_TDAY_COLLECTION_STORE_VISIT_SENT',      //     143
  ...
  anniv_t10: [
    ...
    'ANNIVERSARY_T10_GENDER_SELECTION_SENT',     //    239
    'ANNIVERSARY_T10_MEN_BRAND_CAROUSEL_SENT',   //    168
    'ANNIVERSARY_T10_WOMEN_BRAND_CAROUSEL_SENT', //    211
    'ANNIVERSARY_T10_CATALOGUE_FOLLOW_UP_SENT',  //    225 ✅ ADDED
    'ANNIVERSARY_T10_OFFER_SENT',                //    756
    'ANNIVERSARY_T10_STORE_VISIT_SENT',          //     82
    'ANNIVERSARY_T10_CALLBACK_CONFIRMED',        //     22
  ],
  anniv_t0: [
    // 'ANNIVERSARY_TDAY_TEMPLATE_SENT',                  // 44,885
    'ANNIVERSARY_TDAY_OPENER_SENT',                    //    575
    'ANNIVERSARY_TDAY_GENDER_SELECTION_SENT',          //     31
    'ANNIVERSARY_TDAY_MEN_BRAND_CAROUSEL_SENT',        //     15
    'ANNIVERSARY_TDAY_WOMEN_BRAND_CAROUSEL_SENT',      //     22
    'ANNIVERSARY_TDAY_CATALOGUE_FOLLOW_UP_SENT',       //     24 ✅ ADDED
    'ANNIVERSARY_TDAY_OFFER_SENT',                     //     69
    'ANNIVERSARY_TDAY_COLLECTION_STORE_VISIT_SENT',    //     14
    'ANNIVERSARY_TDAY_COLLECTION_CALLBACK_CONFIRMED',  //      3
  ],
}
...
export const STEP_META = {
  ...
  BIRTHDAY_T10_CATALOGUE_FOLLOW_UP_SENT:    { label: 'Catalogue F/U',   color: '#5B9BD5', bg: '#DBEAFE' },
BIRTHDAY_T10_CALLBACK_CONFIRMED:          { label: '📞 Callback Lead', color: '#0F766E', bg: '#CCFBF1' },
...
BIRTHDAY_TDAY_COLLECTION_CALLBACK_CONFIRMED: { label: '📞 Callback Lead', color: '#0F766E', bg: '#CCFBF1' },
  ...
  ANNIVERSARY_T10_CATALOGUE_FOLLOW_UP_SENT: { label: 'Catalogue F/U',   color: '#5B9BD5', bg: '#DBEAFE' },
ANNIVERSARY_T10_CALLBACK_CONFIRMED:       { label: '📞 Callback Lead', color: '#0F766E', bg: '#CCFBF1' },
...
ANNIVERSARY_TDAY_CATALOGUE_FOLLOW_UP_SENT: { label: 'Catalogue F/U',  color: '#5B9BD5', bg: '#DBEAFE' },
ANNIVERSARY_TDAY_COLLECTION_CALLBACK_CONFIRMED: { label: '📞 Callback Lead', color: '#0F766E', bg: '#CCFBF1' },}
