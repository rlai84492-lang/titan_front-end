...
//         {cfg.emoji} {cfg.label}
//       </span>
//       <button onClick={() => exportExcel(leads, activeFlow)}
//         className="flex items-center gap-1.5 px-3 py-1.5 text-[11px] font-bold rounded-lg transition-all shadow-sm hover:shadow-md hover:-translate-y-0.5"
//         style={{ background: 'linear-gradient(135deg, #059669, #10B981)', color: '#fff' }}>
//         📊 Excel
//       </button>
//       <button onClick={() => exportPDF(leads, activeFlow)}
//         className="flex items-center gap-1.5 px-3 py-1.5 text-[11px] font-bold rounded-lg transition-all shadow-sm hover:shadow-md hover:-translate-y-0.5"
...
// export default function LeadsPage() {
//   const allLeads   = useSelector(s => s.dashboard.leads)
//   const activeFlow = useSelector(s => s.ui.activeFlow)
//   const isBday     = activeFlow?.includes('bday')
//   const cfg        = FLOW_CONFIG[activeFlow] || FLOW_CONFIG.all
