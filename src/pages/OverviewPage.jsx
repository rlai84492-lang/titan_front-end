  ...
  return (
    <div className="min-h-[75vh] flex flex-col items-center justify-center select-none">
      ...
      <div className="relative flex items-center justify-center mb-8">
        ...
        {/* Outer rotating ring */}
        <div
          className="absolute w-28 h-28 rounded-full border-[2.5px] border-transparent"
          style={{
            borderTopColor: cfg.hex,
            borderRightColor: cfg.hex + '30',
      ...
      <div className="text-[10px] text-gray-400 mb-6">
        Fetching campaign data, please wait…
      </div>
      ...
      {/* Skeleton preview — 8 metric cards */}
        ...
        <div className="grid grid-cols-4 sm:grid-cols-8 gap-2.5">
          {[...Array(8)].map((_, i) => (
            <div
              ...
              style={{
                background: `linear-gradient(90deg, #F5F3F0 25%, ${cfg.pulse} 50%, #F5F3F0 75%)`,
                backgroundSize: '300% 100%',
                animation: `shimmer 1.8s ease-in-out ${i * 0.08}s infinite`,
              }}
            />
          ))}
        </div>
          ...
          {[...Array(8)].map((_, i) => (
            <div
              ...
              style={{
                background: `linear-gradient(90deg, #F5F3F0 25%, ${cfg.pulse} 50%, #F5F3F0 75%)`,
                backgroundSize: '300% 100%',
                animation: `shimmer 1.8s ease-in-out ${i * 0.1 + 0.4}s infinite`,
              }}
            />
          ))}
        </div>
          ...
          {[...Array(2)].map((_, i) => (
            <div
              ...
              style={{
                background: `linear-gradient(90deg, #F5F3F0 25%, ${cfg.pulse} 50%, #F5F3F0 75%)`,
                backgroundSize: '300% 100%',
                animation: `shimmer 1.8s ease-in-out ${i * 0.2 + 0.8}s infinite`,
              }}
            />
          ))}
        </div>
...
export default function OverviewPage() {
  ...
  const timeline   = useSelector(s => s.dashboard.timeline)
  const activeFlow = useSelector(s => s.ui.activeFlow)
  const loading    = useSelector(s => s.dashboard.loading)  // ← loading state
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 xl:grid-cols-8 gap-3">
          {[
            ...
            <div
              ...
              style={{ background: c.bg, borderColor: c.color + '22' }}
            >
              <div className="font-sora font-extrabold text-xl" style={{ color: c.color }}>{c.value}</div>
              <div className="text-[9px] font-semibold mt-1 leading-tight" style={{ color: c.color, opacity: 0.8 }}>{c.label}</div>
            </div>
